...
public class CEnvironment implements IEnvironment
{
    ...
    List< IEntity > m_entitis = new ArrayList<>();
    ...
    @Override
    public synchronized IEntity move( IEntity p_entity, DoubleMatrix1D p_position )
    {
    ...
    @Override
    public boolean positionbyondgrid( DoubleMatrix1D p_position )
    {
        return p_position.get( 0 ) >= m_grid.rows() || p_position.get( 1 ) >= m_grid.columns() || p_position.get( 0 ) == 0 || p_position
            .get( 1 ) == 1;
    }
}
