package de.tu_clausthal.in.mec.simulatorsb.simulator.core;
...
{
    /**
     * default step time in ms (supposed to perform ~60 FPS)
     */
    private static final long DEFAULT_TIME_STEP = 1000 / 60;
    /**
     * simulation task
     */
